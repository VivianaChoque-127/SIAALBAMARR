...
<div class="modal fade" id="nuevoLectorForm" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="frmLector" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="modal-body mx-3">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" id="apellido_nuevo" class="form-control m-input--solid validate">
                        </div>
                    </div>
                    <div class="form-group row">
