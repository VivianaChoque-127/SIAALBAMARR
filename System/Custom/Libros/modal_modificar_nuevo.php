...
<div class="modal fade" id="actualizarLibroForm" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" data-backdrop="static">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header d-flex justify-content-center" style="text-align: center; background-color: #773FDF; color:white">
                <h4 class="modal-title w-100 font-weight-bold" style="color:white"><i class="col-sm-2 fa fa-user prefix grey-text" style="color:white"></i>Modificar Libros</h4>
            ...
            <form id="frmLibroActualizar" role="form" method="post" enctype="multipart/form-data" autocomplete="off">
                <div class="modal-body mx-3">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" id="area_update" class="form-control m-input--solid validate" >
                        </div>
                    </div>
                    <div class="form-group row">
                        <label class="col-sm-1 col-form-label" style="text-align: left;">Editorial</label>
                        <div class="col-sm-5">
                            <input type="text" id="editorial_update" class="form-control m-input--solid validate" >
                        </div>
                        <label class="col-sm-1 col-form-label" style="text-align: left;">Autor</label>
                        <div class="col-sm-5">
                            <input type="text" id="autor_up" class="form-control m-input--solid validate" >
                        </div>
                    </div>
                </div>
